                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative w-full">
                                    <select
                                        className="w-full appearance-none border border-gray-300 rounded-md px-3 py-2 pr-12 text-sm text-gray-900 bg-white focus:outline-none focus:ring-1 focus:ring-green-500"
                                    >
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3">
                                        ...
                                        <div className="relative w-full">
                                            ...
                                            {/* Sisi abu-abu kanan + icon */}
                                            <div className="absolute top-0 right-0 h-full w-12 bg-gray-300 
