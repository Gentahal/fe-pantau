...
const activeTasksData = [
  {
    no: 1,
    tugas: "Tambah Tenaga Medis",
    provinsi: "Jawa Timur",
    kabupaten: "Surabaya",
    kecamatan: "-",
    desa: "Antapani Selatan",
    prioritas: "Tinggi",
    target: "1 lokasi",
  },
  {
    no: 2,
    tugas: "Bangun Puskesmas",
...
const completedVisitsData = [
  {
    ...
    kabupaten: "Surabaya",
    desa: "Antapani Selatan",
    tanggalSelesai: "11 November 2025",
    statusVerifikasi: "Laporan Dikirim",
  },
  {
    no: 2,
    tugas: "Bangun Puskesmas",
    ...
    kabupaten: "Jakarta Selatan",
    desa: "Tenggilis",
    tanggalSelesai: "10 November 2025",
  ...
  },
  {
    ...
    kabupaten: "Jakarta Timur",
    desa: "Cibiru",
    tanggalSelesai: "9 November 2025",
  ...
  },
  {
    ...
    kabupaten: "Semarang",
    desa: "Sukajaya",
    tanggalSelesai: "7 November 2025",
    statusVerifikasi: "Disetujui",
  },
  {
    no: 6,
  ...
  },
  {
    ...
    kabupaten: "Bogor",
    desa: "Mekarjaya",
    tanggalSelesai: "8 November 2025",
    statusVerifikasi: "Disetujui",
  },
];
    ...
    <div className="overflow-x-auto border-t border-gray-200">
      <table className="min-w-full">
        <thead className="bg-white">
          <tr>
            <th className="px-3 py-5 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">
              No
            </th>
            <th className="px-3 py-5 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">
              Tugas
            ...
            <th className="px-3 py-5 text-center text-xs font-semibold text-gray-900 uppercase tracking-wider">
              Aksi
            </th>
          </tr>
        </thead>
