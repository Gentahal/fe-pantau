  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 lg:ml-64 p-6 space-y-6 mb-8">
        <Breadcrumb
          homeText="Health Accessibility Index"
          currentPageText="Detail Health Accessibility Index"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border flex justify-between items-center">
              <div className="flex flex-col justify-between">
                <h3 className="font-semibold mb-2 text-[#2E7D32]">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border shadow-sm">
              <h4 className="font-semibold mb-3 text-gray-900">
                Puskesmas: Puskesmas Harapan Umat
              </h4>
              <ul className="text-sm space-y-2 text-gray-900">
                <li> Jl. Raya Terusan Buah Batu No 12</li>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <section className="bg-[#E8F5E9] border border-green-200 p-6 rounded-2xl shadow-sm flex-1">
            ...
            <p className="text-[#2E7D32]">
              Fokus pada Puskesmas karena transportasi ke fasilitas kesehatan
              cukup terbatas. Dan konsman layanan kamar perawatan jarak dan
              pengingatannya rendah, lebih baik mengalihkan rujukan ke layanan
              antara fasilitas kesehatan yang ada di desa ini.
            </p>
          </section>
